...
<head>
    ...
    <title>Dashboard Crazy-Pictures</title>
...
<body>
    ...
    <div class="page-container">
        ...
        <footer class="footer">
            <div class="footer-area">
                <p>2019 © Copyright crazy-pictures.at - Lukas & Thomas Wagner. All rights Reserved.</p>
            </div>
        </footer>
        <!-- footer area end-->
    </div>
	...
	<?php
		...
		echo "Log In! - <a href='index.php'>LoginPage</a>";
	}
